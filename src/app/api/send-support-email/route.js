...
const generateEmailContent = (data) => ({
  subject: "Contact Form Submission from GTC Website",
  html: `
<!DOCTYPE html>
<html>
<head>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-radius: 36px; padding: 20px; background-color: #fff; width: 100%;">
                        ...
                        <tr>
                            <td class="content" style="width: 100%;">
                                ...
                                <p style="line-height: 30px; padding-top: 20px;">Best Regards,<br><strong style="color: #192055; margin-top: 5px;">GTC Team</strong></p>
                            </td>
                        </tr>
                        <tr>
...
const generateEmailContentSignUp = (data) => ({
  subject: "Affilicate Form Submission from GTC Website",
  html: `
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>New GTC Affiliate Query Submitted</title>
    <link
          ...
          >
            ...
            >
              <tr>
                <td class="header" style="padding: 20px; text-align: center">
                  <img
                    src="https://www.gtcaffiliates/logogtcpay.png"
                    alt="GTC Global Capital Trade Logo"
              ...
              <tr>
                <td class="content" style="width: 100%">
                  <h1
                    ...
                    "
                  >
                    New GTC Affiliate Query Submitted
                  </h1>
                  <h3 style="font-size: 16px; color: #192055">
                    Dear Admin/Support Team,
                  </h3>
                  <p>
                    A new query has been submitted through the GTC Affiliate
                    form on our website. Please find the details below to follow
                    up accordingly:
                  </p>

                  <h2 style="color: #192055; font-size: 16px">Information</h2>
                  <table
                    class="content-table"
                    style="
                      width: 100%;
                  ...
                  <p style="line-height: 30px; padding-top: 20px">
                    Please respond to this query promptly to ensure customer
                    satisfaction. Thank you.
                  </p>
                  <p style="line-height: 30px; padding-top: 20px">
                    Best Regards,<br /><strong
                      style="color: #192055; margin-top: 5px"
                      >GTC Team</strong
                    >
                  </p>
                </td>
              ...
              <tr>
                ...
                >
                  <div class="social-icons" style="padding-bottom: 10px">
                    <a
                      href="https://www.facebook.com/gtcfxofficial"
                      style="text-decoration: none"
                      target="_blank"
                    >
                      <img
                        alt="Facebook"
                        src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/default/facebook_96.png"
                        style="width: 24px; height: 24px; margin: 0 5px"
                      />
                    </a>
                    <a
                      href="https://twitter.com/GTC_fx"
                      style="text-decoration: none"
                      target="_blank"
                    >
                      <img
                        alt="Twitter"
                        src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/default/twitter_96.png"
                        style="width: 24px; height: 24px; margin: 0 5px"
                      />
                    </a>
                    <a
                    ...
                    >
                      <img
                        alt="LinkedIn"
                        src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/default/linkedin_96.png"
                        style="width: 24px; height: 24px; margin: 0 5px"
                      />
                    </a>
                    <a
                      href="https://www.youtube.com/channel/UCnKWakjm1b9Bm63xgwNFXHA"
                      style="text-decoration: none"
                      target="_blank"
                    >
                      <img
                        alt="YouTube"
                        src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/default/youtube_96.png"
                        style="width: 24px; height: 24px; margin: 0 5px"
                      />
                    </a>
                    <a
                    ...
                    >
                      <img
                        alt="Instagram"
                        src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/default/instagram_96.png"
                        style="width: 24px; height: 24px; margin: 0 5px"
                      />
                    </a>
                    <a
                      href="https://www.tiktok.com/@gtcgroup_official"
                      style="text-decoration: none"
                      target="_blank"
                    >
                      <img
                        alt="TikTok"
                        src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/default/tiktok_96.png"
                        style="width: 24px; height: 24px; margin: 0 5px"
                      />
                    </a>
                  </div>
                  ...
                  <p
                    style="font-size: 9px; line-height: 13px; text-align: left"
                  >
                    ...
                    your own financial goals and situation. Investing in
                    contract for difference products carries significant risks
                    and may not be suitable for all investors. Losses may exceed
                    the initial deposit. You do not have ownership rights to the
                    underlying assets of the contract. We advise seeking
                    professional guidance to fully understand the risks before
                    trading. Please review our user terms, risk warnings,
                    privacy policy, and other relevant documents before making
                    financial decisions.
                  </p>
                  <p
                    style="font-size: 9px; line-height: 13px; text-align: left"
                  >
                    Note that our products and services are not available in
