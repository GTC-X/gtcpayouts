    ...
    <section className="w-full bg-[#F3F8FC]">
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-10">
          <div>
            <h2 className="text-[28px] leading-[1.2] font-semibold text-[#0A2A47]">
              How Much You’ll Earn as a GTC
              <span className="block">Affiliate</span>
            </h2>
            <p className="mt-4 text-[16px] leading-[1.6] text-[#4B5C6B] max-w-[540px]">
              Move the slider to see just how much you could be making with
              GTC’s monster CPA rates. The more traffic you bring, the more
              traders sign up, and the bigger your payouts grow.
            </p>
          </div>
          ...
          <div className="pt-4 md:pt-2">
            ...
            <div className="mt-6 grid grid-cols-2 gap-6">
              {/* Left metric */}
              <div>
                <div className="text-[28px] font-bold leading-none text-[#0A2A47]">
                  {fmt(value)}
                </div>
                <div className="mt-1 text-[13px] font-medium tracking-wide text-[#0A2A47]/70">
                  Total traders
              ...
              <div className="text-right">
                <div className="text-[28px] font-extrabold leading-none text-[#12A5CF]">
                  ${fmt(payout)}
                </div>
                <div className="mt-1 text-[13px] font-medium tracking-wide text-[#0A2A47]/70">
                  Your total payouts
