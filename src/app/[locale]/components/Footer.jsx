    ...
    return (
        ...
        <section className="w-full bg-[#04417B] py-10 md:py-14">
            <div className="container mx-auto px-4 text-left flex flex-col space-y-2.5 text-white text-sm">
               ...
               <p><span class="text-secondary">GTC Global Ltd and GTC Global Trade Capital Co. Limited </span> belong to the GTC Financial Group which consists of a group of entities across the globe. </p>
               ...
               <p><span class="text-secondary">GTC Global Ltd and GTC Global Trade Capital Co. Limited </span>do not provide services to individuals residing in specific jurisdictions and/or jurisdictions where distribution of such services would be contrary to local law or regulation.</p>
               ...
               <p>The <span class="text-secondary">GTCPayouts.com</span> website is owned and operated by GTC Global Ltd, a limited company incorporated in Mauritius (company number: C188049) and licensed by the Financial Services Commission, Mauritius (No. GB22200292) to trade as an SEC-2.1B Investment Dealer. Registered Address: Cyberati Lounge, Ground Floor, the Catalyst, Silicon Avenue, 40 Cybercity, 72201 Ebene, Republic of Mauritius.</p>
