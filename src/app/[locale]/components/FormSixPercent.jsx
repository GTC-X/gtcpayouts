...
const FormSixPercent = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                setLoading(true);
                await axios.post(
                    "https://hooks.zapier.com/hooks/catch/16420445/u9jji1r/",
    ...
    return (
        <div className="relative max-w-xl mx-auto px-6 pt-7 pb-6">
            <form
                onSubmit={formik.handleSubmit}
                className="relative text-sm rounded-3xl md:p-0 mx-auto form-setting ltr:text-left rtl:text-right text-[#0F172A]"
            >
                {/* Full Name & Email */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full px-4 bg-white py-3 pl-3 text-base border-[.5px] rounded-md border-opacity-10  ${formik.touched.nickname && formik.errors.nickname
                                ? "border-red-500"
                                : " border-[#CCCCD6] "
                                } focus:outline-none`}
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            autoComplete="off"
                            className={`w-full px-4 bg-white text-base py-3 pl-3 border-[.5px] rounded-md border-opacity-10  ${formik.touched.last_name && formik.errors.last_name
                                ? "border-red-500"
                                : " border-[#CCCCD6] "
                                } focus:outline-none`}
                ...
                <div className="grid grid-cols-1 gap-3 mb-3">
                    <div className="relative">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full bg-white px-4 py-3 pl-3 text-base border-[.5px] border-[#ccccd679] rounded-md border-opacity-30 ${formik.touched.email && formik.errors.email
                                    ? "border-red-500"
                                    : "border-[#CCCCD6]"
                    ...
                    <div className="relative">
                        <div className="text-sm mb-2 text-[#0F172A]">
                        ...
                        <PhoneInput
                            ...
                            className={`flex w-full overflow-hidden rounded-md text-base border border-[#CCCCD6] bg-white phone-setting text-white focus:outline-none
